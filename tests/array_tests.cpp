...
TEST_CASE("Array Tests") {
    ...
    SECTION("Swap test") {
        ...
        SECTION("custom structure") {
            ...
            REQUIRE(
                    ts_array_1.to_string() ==
                    "[{ value: 10 flag: 1 }, { value: 10 flag: 1 }, { value: 10 flag: 1 }, { value: 10 flag: 1 }]"
            );

            REQUIRE(
                    ts_array_2.to_string() ==
                    "[{ value: 10 flag: 1 }, { value: 10 flag: 1 }, { value: 10 flag: 1 }, { value: 10 flag: 1 }]"
            );
        }
        ...
        SECTION("custom pointer") {
            ...
            REQUIRE(
                    pint_array_1.to_string() ==
                    "[{ value: 10 flag: 1 }, { value: 10 flag: 1 }, { value: 10 flag: 1 }, { value: 10 flag: 1 }]"
            );

            REQUIRE(
                    pint_array_2.to_string() ==
                    "[{ value: 10 flag: 1 }, { value: 10 flag: 1 }, { value: 10 flag: 1 }, { value: 10 flag: 1 }]"
            );
            delete ptr_1;
            delete ptr_2;
    ...
    SECTION("Iterator tests") {
        ...
        SECTION("custom structure") {
            ...
            REQUIRE(ts_array.size() == 4);
            ts_array.fill(test_struct{});
            for (auto it = ts_array.begin(); it != ts_array.end(); ++it) {
